...
(function () {
  ...
  const cfg = {
    ...
    readContainer: (scriptEl?.dataset?.readContainer || "main").toString(),
  };
...
`;
  ...
  function setupMessaging(iframe) {
    window.addEventListener("message", (event) => {
      ...
      if (msg.type === "A11Y_REQUEST_INIT") {
        ...
        postToPanel(iframe, {
          type: "A11Y_INIT",
          payload: { lang: cfg.lang, color: cfg.color,readContainer: cfg.readContainer }
        });
      }
  ...
  function bootstrap() {
    ...
    function openClosePanel() {
      ...
      postToPanel(iframe, { type: "A11Y_INIT", payload: { lang: cfg.lang, color: cfg.color,readContainer: cfg.readContainer } });
    }
